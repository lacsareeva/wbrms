<div id="walk-in-request-modal" class="modal">
    <div class="modal-content">
        ...
        <div class="borrowedContents">
            <form method="POST" action="{{ route('admin.borrowed.save') }}" enctype="multipart/form-data"
                onsubmit="return validateContact()">
                @csrf
                <div class="form-section">
                    <div class="form-section1">
                        <label for="first-name">Fullname:</label><br>
                        <input type="text" id="Fullname" name="name" required autofocus>
                    </div>
                    <div class="form-section2">
                        <label for="address">Address:</label><br>
                        <input type="text" id="create_address" name="address" required>
                    </div>
                </div>
                <div class="form-section">
                    <div class="form-section1">
                        ...
                        <input type="text" id="customInput" name="equipment" style="display:none;" placeholder="Enter custom value">
